...
use crate::core::{cartas::{compra_cartas, compra_cartas_especial, curar_personagem, dano_bang, descartar_carta, usar_bang_alvo, usar_panico_alvo, DescartaCarta, JogadorCartaAlvo, LogCarta}, iniciar_jogo, jogos::{self, carrega_jogos, carregar_jogo, entrar_jogo, passar_turno}, personagens::lista_personagens, AppState, Jogo};
...
pub fn cria_rotas() -> Router<>{
    ...
    let app: Router<_> = Router::new()
        ...
        .route("/compra_cartas_especial", post(compra_cartas_especial))
        .route("/usar_panico_alvo", post(usar_panico_alvo))
